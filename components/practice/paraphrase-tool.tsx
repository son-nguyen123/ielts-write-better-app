  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        let errorMessage = result?.error || "Failed to generate paraphrases. Please try again."
        ...
        // Check for rate limit errors
          ...
          errorMessage = result?.error || "AI diễn giải đang vượt giới hạn sử dụng. Vui lòng thử lại sau vài phút."
        }
